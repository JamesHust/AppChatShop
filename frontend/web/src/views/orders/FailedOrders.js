  ...
  const usersData = [
    {
      ...
      reason:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sit amet nulla consequat, interdum sem sed, lobortis purus. Curabitur porttitor felis eu leo accumsan, a vestibulum metus maximus. Vestibulum pharetra mauris et convallis pulvinar. Phasellus rutrum, orci sed luctus euismod, eros tellus dictum ante, finibus mollis ex urna ac mi. Suspendisse efficitur est eget turpis pharetra congue.",
      products: [
        {
          ...
          <div>
            ...
            <div className="mt-3">
              ...
              >
                ...
                <div>{dataModal.modifyDate}</div>
              </div>
              <div className="mt-2">
                <div>Lý do thất bại:</div>
                <CTextarea value={dataModal.reason} rows={4} className="mt-1" />
              </div>
            </div>
          </div>
        </CModalBody>
